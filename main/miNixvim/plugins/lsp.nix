        ...
        nixd = {
          ...
          settings = {
            ...
            options = {
              ...
              home-manager.expr = "(builtins.getFlake \"/etc/nixos\").nixosConfigurations.nixos.options.home-manager.users.value.portable";
              nixvim.expr = "(builtins.getFlake \"/etc/nixos\").nixosConfigurations.nixos.options.home-manager.users.value.portable.programs.nixvim";
