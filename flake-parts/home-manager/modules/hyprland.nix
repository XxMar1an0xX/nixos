    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        bind = [
          ...
          "$mainMod, plus, exec, pactl set-sink-volume @DEFAULT_SINK@ +5%"
          "$mainMod, KP_Add, exec, pactl set-sink-volume @DEFAULT_SINK@ +5%"
          ", xf86audiolowervolume, exec, pactl set-sink-volume @DEFAULT_SINK@ -5%"
          "$mainMod, minus, exec, pactl set-sink-volume @DEFAULT_SINK@ -5%"
          "$mainMod, KP_Subtract, exec, pactl set-sink-volume @DEFAULT_SINK@ -5%"
